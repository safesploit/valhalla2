...
//Set Symbolic File Upload Directory
$symDir = 'assets/images/profile_pics/upload/';	
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		//save the new cropped version
			imagejpeg($dst_r, $symDir.$finalname."n.jpeg", 90); 	
		...
		$result_path =$symDir.$finalname."n.jpeg";
...
<div class="main_column column">
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        Upload a New Profile Image<br /><br />
