...
<div class="main_column column">
	...
	echo "<img src='" . $profilePic ."' class='small_profile_pic'>";
	?>
	<br>
	...
	<?php
		$row = $user_obj->settingsUserArray();
	...
	<form action="settings.php" method="POST">
		<span>First Name: </span><input type="text" name="first_name" value="<?php echo $firstname; ?>" class="settings_input" placeholder="First Name" required><br>
		<span>Last Name: </span><input type="text" name="last_name" value="<?php echo $lastname; ?>" class="settings_input" placeholder="Last Name" required><br>
	...
	<form action="settings.php" method="POST">
		...
		<?php echo $password_message; //echo $passwordMessage; ?>
	...
	if($userLoggedIn == "safesploit")
	{
		...
		echo 	"	<form action='settings.php' method='POST'>
						<span>Generate Code: </span><input type='text' name='gen_invite_code' class='settings_input' placeholder='Generated Code HERE' value='$genInviteCode'>
