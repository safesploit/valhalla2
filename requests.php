	...
	<?php 
		...
		else
		{
			while($row = mysqli_fetch_array($query))
			{
				...
				//echo "<b>" . $user_from_obj->getFirstAndLastName() . "</b>" . " sent you a friend request!"; //LEGACY
				echo "<b>" . "<a href=" . "$user_from" . "> " . $user_from_obj->getFirstAndLastName() . " </a> " . "</b>" . " sent you a friend request!";
